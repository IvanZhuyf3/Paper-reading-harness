...
| Asked IDs are unique | PASS | count=24 |
...
| Unique next interaction is persisted | PASS | cursor=EVIDENCE.M3.awaiting_application_performance_link, pending_prompt=EVIDENCE_M3_APPLICATION_PERFORMANCE_LINK |
| Event sequence is contiguous | PASS | events=23 |
