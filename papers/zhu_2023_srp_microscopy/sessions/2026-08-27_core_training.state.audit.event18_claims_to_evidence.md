...
| Asked IDs are unique | PASS | count=19 |
...
| Unique next interaction is persisted | PASS | cursor=EVIDENCE.M1.awaiting_thermometry_validity, pending_prompt=EVIDENCE_M1_THERMOMETRY_VALIDITY |
