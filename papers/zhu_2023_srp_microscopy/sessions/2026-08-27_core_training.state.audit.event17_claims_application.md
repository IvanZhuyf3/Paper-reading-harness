...
| Asked IDs are unique | PASS | count=18 |
...
| Unique next interaction is persisted | PASS | cursor=CLAIMS.awaiting_finish_confirmation, pending_prompt=CLAIMS_FINISH |
| Event sequence is contiguous | PASS | events=17 |
