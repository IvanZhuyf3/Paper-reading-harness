...
| Asked IDs are unique | PASS | count=7 |
| Selection seed is persisted | PASS | 2026082701 |
| Human-node parents resolve | PASS | missing=[] |
| Unique next interaction is persisted | PASS | cursor=CLAIMS.T0.awaiting_first_major_claim, pending_prompt=CLAIMS_ADD_T0 |
| Event sequence is contiguous | PASS | events=6 |
