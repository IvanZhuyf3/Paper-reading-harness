...
| Asked IDs are unique | PASS | count=15 |
...
| Unique next interaction is persisted | PASS | cursor=CLAIMS.H-C3.3.awaiting_similarity_metric, pending_prompt=CLAIMS_CLARIFY_H-C3.3_SIMILARITY_METRIC |
