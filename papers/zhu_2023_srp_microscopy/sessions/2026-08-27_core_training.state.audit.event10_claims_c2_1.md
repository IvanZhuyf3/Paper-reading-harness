...
| Asked IDs are unique | PASS | count=11 |
...
| Unique next interaction is persisted | PASS | cursor=CLAIMS.T0.awaiting_next_major_claim, pending_prompt=CLAIMS_ADD_T0_3 |
| Event sequence is contiguous | PASS | events=10 |
