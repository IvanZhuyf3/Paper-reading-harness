...
| Current stage is valid | PASS | independent_reading |
| Completed stages form the prefix before the current stage | PASS | completed=['knowledge', 'idea', 'claims', 'evidence'], expected=['knowledge', 'idea', 'claims', 'evidence'] |
| Asked IDs are unique | PASS | count=28 |
...
| Unique next interaction is persisted | PASS | cursor=INDEPENDENT_READING.awaiting_human_completion, pending_prompt=INDEPENDENT_READING_COMPLETE |
| Event sequence is contiguous | PASS | events=27 |
