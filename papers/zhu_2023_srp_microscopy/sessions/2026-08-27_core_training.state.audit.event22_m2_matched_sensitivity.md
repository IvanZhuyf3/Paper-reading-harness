...
| Asked IDs are unique | PASS | count=23 |
...
| Unique next interaction is persisted | PASS | cursor=EVIDENCE.M2.awaiting_bead_deconvolution, pending_prompt=EVIDENCE_M2_RESOLUTION_BEAD_DECONVOLUTION |
| Event sequence is contiguous | PASS | events=22 |
