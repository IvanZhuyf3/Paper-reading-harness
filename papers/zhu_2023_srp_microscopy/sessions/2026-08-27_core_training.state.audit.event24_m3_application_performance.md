...
| Unique next interaction is persisted | PASS | cursor=EVIDENCE.M3.awaiting_feature_recognition_validity, pending_prompt=EVIDENCE_M3_FEATURE_RECOGNITION_VALIDITY |
| Event sequence is contiguous | PASS | events=24 |
