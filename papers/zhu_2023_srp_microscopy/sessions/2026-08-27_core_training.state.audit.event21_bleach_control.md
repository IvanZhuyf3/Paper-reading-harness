...
| Asked IDs are unique | PASS | count=22 |
...
| Unique next interaction is persisted | PASS | cursor=EVIDENCE.M2.awaiting_matched_sensitivity_comparison, pending_prompt=EVIDENCE_M2_MATCHED_SENSITIVITY_COMPARISON |
| Event sequence is contiguous | PASS | events=21 |
