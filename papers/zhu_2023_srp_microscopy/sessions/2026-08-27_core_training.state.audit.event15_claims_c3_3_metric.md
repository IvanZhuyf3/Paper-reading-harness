...
| Asked IDs are unique | PASS | count=16 |
...
| Unique next interaction is persisted | PASS | cursor=CLAIMS.H-C3.5.awaiting_speed_metric, pending_prompt=CLAIMS_EXPAND_H-C3.5_SPEED |
| Event sequence is contiguous | PASS | events=15 |
