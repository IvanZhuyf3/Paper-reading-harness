...
| Asked IDs are unique | PASS | count=8 |
...
| Unique next interaction is persisted | PASS | cursor=CLAIMS.H-C1.1.awaiting_causal_claim, pending_prompt=CLAIMS_EXPAND_H-C1.1 |
| Event sequence is contiguous | PASS | events=7 |
