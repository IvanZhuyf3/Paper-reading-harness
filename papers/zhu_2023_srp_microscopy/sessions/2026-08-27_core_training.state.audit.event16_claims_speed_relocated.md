...
| Asked IDs are unique | PASS | count=17 |
...
| Unique next interaction is persisted | PASS | cursor=CLAIMS.awaiting_finish_or_add, pending_prompt=CLAIMS_FINISH_OR_ADD |
| Event sequence is contiguous | PASS | events=16 |
