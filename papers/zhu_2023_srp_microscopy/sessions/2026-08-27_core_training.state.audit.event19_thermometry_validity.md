...
| Asked IDs are unique | PASS | count=20 |
...
| Unique next interaction is persisted | PASS | cursor=EVIDENCE.M1.awaiting_thermometry_controls, pending_prompt=EVIDENCE_M1_THERMOMETRY_CONFOUNDS |
| Event sequence is contiguous | PASS | events=19 |
